    ...
    <div className='w-full px-[12%] py-10 scroll-mt-20' id='about'>
       ...
       <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        <div className='flex-1'>
                <p className='mb-10 max-w-2xl font-Ovo'>Skilled REACT JS Developer with 2.3+ years of experience in front-end and back-end development, specializing in React.js, 
